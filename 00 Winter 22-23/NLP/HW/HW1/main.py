...
def main():
    ...
    weights_1_path_200_300_th3 = "weights_200_300_tresh2.pkl" # threshold 3
    ...
    #     f300=True,
    # )
    train_model(train_1_path, weights_1_path_200_300_th3, threshold=3, lam=1, f200=True, f300=True)
